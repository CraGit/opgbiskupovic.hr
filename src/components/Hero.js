...
export default function Hero({ heading, slider, settings }) {
  ...
  return (
    <div className="hiro-sec relative -top-0 pt-24 pb-0 lg:h-screen bg-white h-full">
      <div className="w-full max-w-6xl mx-auto">
        <h1 className="text-2xl lg:text-5xl lg:leading-normal max-lg:text-center text-[#7C7669] font-normal tracking-wide font-prata mb-12 max-w-3xl lg:max-w-full mx-auto">
          {heading}
        </h1>
      </div>
            ...
            <div className="flex gap-x-5">
              {data.facebook && (
                <a
                  ...
                  className="w-10 h-10 flex items-center text-gray-900 justify-center rounded-full border border-gray-300 transition-all duration-500 hover:text-s_skin hover:border-s_skin"
                >
                  <svg
                    width="19"
                    height="19"
